...
public class ConfiguracionScrim {
    ...
    // Lista de rangos en orden de peor a mejor
    ...
    public boolean esRangoValido(String rangoJugador) {
        if (rangeMin == null || rangeMax == null || rangoJugador == null) return false;
        ...
        if (indexJugador == -1 || indexMin == -1 || indexMax == -1) return false;
    ...
    public void setRangeMin(String rangeMin) { this.rangeMin = rangeMin; }

    public String getRangeMax() { return rangeMax; }
    public void setRangeMax(String rangeMax) { this.rangeMax = rangeMax; }
